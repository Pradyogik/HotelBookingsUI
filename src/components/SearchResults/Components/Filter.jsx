...
const filters = [
    {
        ...
        name: 'Sort By',
        options: [
            { value: 'power_backup', label: 'Power Backup', checked: false },
            { value: 'free_newspaper', label: 'Free Newspaper', checked: false },
            { value: 'laundry', label: 'Laundry', checked: true },
            ...
            <div>
                            ...
                            >
                                <Dialog.Panel className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl">
                                    ...
                                    <form className="mt-4 border-t border-black-200">
                                        ...
                                        <ul role="list" className="px-2 py-3 font-Montserrat font-medium text-black-900">
                                            <li>
                                                <a href="#" className='font-Montserrat font-bold'>Search Filters</a>
                                            </li>
                                            <li>
                                                <a href="#" className=' font-Montserrat font-bold'>Sort By</a>
                                            </li>
                                        </ul>
                ...
                <main className="mx-8 max-w-8xl px-4 sm:px-6 lg:px-8">
                    <div className="flex items-baseline justify-between border-b border-black-200 pb-6 pt-24">
                        <h1 className="text-4xl font-bold tracking-tight font-Montserrat text-black-900">Search results are</h1>
                        ...
                        <div className="flex items-center">
                            ...
                            <Menu as="div" className="relative inline-block text-left">
                                <div>
                                    <Menu.Button className="group inline-flex justify-center text-sm font-medium text-black-700 hover:text-black-900 font-Montserrat">
                                        Sort
                                        <ChevronDownIcon
                            ...
                            <button type="button" className="-m-2 ml-5 p-2 font-Montserrat text-black-400 hover:text-black-500 sm:ml-7">
                        ...
                        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                            ...
                            <form className="hidden lg:block">
                                <div className="px-2 py-3 font-Montserrat font-medium text-gray-900">
                                    <h2 className='text-lg  font-bold  font-Montserrat'>Search Filters</h2>
                                </div>
                                    ...
                                    <Disclosure as="div" key={section.id} className="border-b border-gray-300 py-6">
                                        {({ open }) => (
                                            <>
                                                <h3 className="-my-3 flow-root">
                                                    <Disclosure.Button className="flex  w-full items-center justify-between bg-white py-3 text-sm text-black-400 hover:text-black-500 font-Montserrat">
                                                        <span className=" font-Montserrat text-lg font-bold text-black">{section.name}</span>
                                                        <span className="ml-6 flex items-center">
                                                            {open ? (
                                                                <MinusIcon className="h-5 w-5" aria-hidden="true" />
                                                            ) : (
                                                        ...
                                                        {section.options.map((option, optionIdx) => (
                                                            <div key={option.value} className="flex items-center">
                                                                ...
                                                                <label
                                                                    ...
                                                                    className="ml-3 text-sm text-black font-medium font-Montserrat"
                                                                >
                                                                    {option.label}
                                                                </label>
                                                            </div>
